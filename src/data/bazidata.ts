...
// ① 十二长生状态表（地支 × 十干）——天干气机强弱的唯一衡量标准（与 03 文档各月十干状态一致）
export const SHI_ER_CHANG_SHENG: Record<string, Record<string, string>> = {
  子: { 甲: '沐浴', 乙: '病', 丙: '胎', 丁: '绝', 戊: '胎', 己: '绝', 庚: '死', 辛: '长生', 壬: '帝旺', 癸: '临官' },
  丑: { 甲: '冠带', 乙: '衰', 丙: '养', 丁: '墓', 戊: '养', 己: '墓', 庚: '墓', 辛: '养', 壬: '衰', 癸: '冠带' },
  寅: { 甲: '临官', 乙: '帝旺', 丙: '长生', 丁: '死', 戊: '长生', 己: '死', 庚: '绝', 辛: '胎', 壬: '病', 癸: '沐浴' },
  卯: { 甲: '帝旺', 乙: '临官', 丙: '沐浴', 丁: '病', 戊: '沐浴', 己: '病', 庚: '胎', 辛: '绝', 壬: '死', 癸: '长生' },
  辰: { 甲: '衰', 乙: '冠带', 丙: '冠带', 丁: '衰', 戊: '冠带', 己: '衰', 庚: '养', 辛: '墓', 壬: '墓', 癸: '养' },
  巳: { 甲: '病', 乙: '沐浴', 丙: '临官', 丁: '帝旺', 戊: '临官', 己: '帝旺', 庚: '长生', 辛: '死', 壬: '绝', 癸: '胎' },
  午: { 甲: '死', 乙: '长生', 丙: '帝旺', 丁: '临官', 戊: '帝旺', 己: '临官', 庚: '沐浴', 辛: '病', 壬: '胎', 癸: '绝' },
  未: { 甲: '墓', 乙: '养', 丙: '衰', 丁: '冠带', 戊: '衰', 己: '冠带', 庚: '冠带', 辛: '衰', 壬: '养', 癸: '墓' },
  申: { 甲: '绝', 乙: '胎', 丙: '病', 丁: '沐浴', 戊: '病', 己: '沐浴', 庚: '临官', 辛: '帝旺', 壬: '长生', 癸: '死' },
  酉: { 甲: '胎', 乙: '绝', 丙: '死', 丁: '长生', 戊: '死', 己: '长生', 庚: '帝旺', 辛: '冠带', 壬: '沐浴', 癸: '病' },
  戌: { 甲: '养', 乙: '墓', 丙: '墓', 丁: '养', 戊: '墓', 己: '养', 庚: '衰', 辛: '冠带', 壬: '冠带', 癸: '衰' },
  亥: { 甲: '长生', 乙: '死', 丙: '绝', 丁: '胎', 戊: '绝', 己: '胎', 庚: '病', 辛: '沐浴', 壬: '临官', 癸: '帝旺' },
}

// ② 五虎遁·年上起月（年干 → 寅月天干，其余月顺推）
// 口诀：甲己之年丙作首，乙庚之岁戊为头。丙辛必定寻庚起，丁壬壬位顺行流。若问戊癸何方发，甲寅之上好追求。
export const WU_HU_DUN_MONTH_STEM: Record<string, string> = {
  甲: '丙', 己: '丙', // 甲己之年丙作首
  乙: '戊', 庚: '戊', // 乙庚之岁戊为头
  丙: '庚', 辛: '庚', // 丙辛必定寻庚起
  丁: '壬', 壬: '壬', // 丁壬壬位顺行流
...
// ③ 月令太极两仪体系（《太极阴阳法》核心：定位当月固有太极，明辨阳仪、阴仪核心干支）
export interface INianYueTaiJiDef {
  months: string[];       // 适用月令（中文月名）
  name: string;           // 太极名
  yangYi: string;         // 阳仪核心天干
  yinYi: string;          // 阴仪核心天干
  yangYiMeaning: string;  // 阳仪含义
  yinYiMeaning: string;   // 阴仪含义
  note: string;           // 分析要点
}

export const NIAN_YUE_TAIJI_DEFS: INianYueTaiJiDef[] = [
  {
    months: ['寅月', '卯月'],
    name: '春月丙癸太极',
    yangYi: '丙', yinYi: '癸',
    yangYiMeaning: '丙为阳仪，主富',
    yinYiMeaning: '癸为阴仪，主贵',
    note: '丙癸二气无伤，为富贵格局基础；丙无伤则富、癸无伤则贵；阴仪无需天干透出，根气暗藏且不受重创即可成格。',
  },
  {
    months: ['申月', '酉月'],
    name: '秋月丁壬太极',
    yangYi: '丁', yinYi: '壬',
    yangYiMeaning: '丁为阳仪（秋金余热）',
    yinYiMeaning: '壬为阴仪（秋令凉润）',
    note: '丁壬相配构成秋月平衡太极；丁壬二气定格局，以土是否得火烘热区分余热、成凉两局，取用随之反转。',
  },
  {
    months: ['辰月', '戌月'],
    name: '杂气月·通透阴阳',
    yangYi: '甲', yinYi: '癸',
    yangYiMeaning: '甲木疏土破迷显阳',
    yinYiMeaning: '癸水为贵气唯一来源',
    note: '阴阳气机混浊不明，需通透阴阳二气；辰月救癸水存阴、戌月破阴显阳，甲木疏土为核心（古言「辰戌无贵」需救）。',
  },
  {
    months: ['巳月', '午月', '未月'],
    name: '夏月·庚水救阴',
    yangYi: '庚', yinYi: '癸',
    yangYiMeaning: '庚金凉土晦火存阴',
    yinYiMeaning: '水木同现救阴润燥',
    note: '阳极无阴，庚金为第一用神（夏月唯一可立足之阴），水木、阴土（戌丑）辅助平衡燥热，孤水孤木皆败。',
  },
  {
    months: ['亥月', '子月', '丑月'],
    name: '冬月·丙甲暖阳',
    yangYi: '丙', yinYi: '甲',
    yangYiMeaning: '丙火暖局破寒',
    yinYiMeaning: '甲木泄水生温',
    note: '阴极藏阳，土制寒、木泄寒、火暖局为三大核心用法；阳暖为富贵根本，无火仅戊土则衣食无忧无大贵。',
  },
]

// ④ 年干先天定位 / 年支三类作用规则（《太极阴阳法》1.2 / 1.3）
export const NIAN_TAIJI_RULES = {
  yearStem: '年干是命局吉凶的核心来源，不可脱离月令单独论断；年干为月令所需的平衡因子，则为先天年吉，此根基永久存在；先天年吉可被日时、岁运干支否定。',
  yearBranch: [
    '年干主「天象、契机、想法」，年支主「落地、成形、兑现」，遵循「在天成象，在地成形」；',
    '① 年干得吉、年支有效落实，且日时干支无破坏：先天年吉可完整兑现；',
    '② 年干得吉、年支或月令予以否定：先天契机极佳，但现实落地阻碍重重，人生跌宕起伏；',
    '③ 年干为忌、年支制衡否定：可借忌神得阶段性利好，但凶性底色不变，逢气机引动之时必应凶。',
  ],
  taijiState: [
    '两仪完整：阳仪气机彰显（透出或有力），阴仪根气暗藏且不受重创，年月太极完好；',
    '两仪受损：阳仪或阴仪一方受创（被克、无根、受晦），仍有残余气机；',
    '两仪绝境：一方彻底无根或遭重创压制，阴阳隔绝，年月太极不立。',
  ],
  gengYan: '所有月令均同时包含阴阳二气，仅气机强弱差异，分析需兼顾阴阳两仪，不可固化「体阴用阳、体阳用阴」标签；常规格局特例：全盘木火亦可成富贵，核心为阳仪气机彰显、阴仪暗藏无伤。',
}

// ⑤ 典型格局实例（甲X年·丙寅月系列，来自《太极阴阳法》第三章）
export interface INianYueCase {
  id: number;
  yearGZ: string;   // 年柱干支
  monthGZ: string;  // 月柱干支
  title: string;    // 格局标签
  analysis: string; // 新书论断
}

export const NIAN_YUE_TAIJI_CASES: INianYueCase[] = [
  { id: 1, yearGZ: '甲子', monthGZ: '丙寅', title: '先天年吉·落地兑现', analysis: '年月干支无核心硬伤，年支子水直接落实癸水阴仪，寅木稳固丙火阳仪。日时干支不损伤丙、癸二气，则格局成富贵；伤癸无救则失贵气，损丙火则减富气。' },
  { id: 2, yearGZ: '甲寅', monthGZ: '丙寅', title: '木火成势·阴仪悬空', analysis: '年月木火成势，无先天阴气保障。格局核心要求水火二气互不损伤，最终吉凶由日时干支保全癸水阴仪的状态决定。' },
  { id: 3, yearGZ: '甲辰', monthGZ: '丙寅', title: '阴仪受损·需日时救助', analysis: '年支辰土克耗癸水贵气，先天阴仪受损。日时需见庚、壬、寅、卯水木之气救助癸水；若再见辰、戌、丑湿土，癸水无救，格局无贵。' },
  { id: 4, yearGZ: '甲午', monthGZ: '丙寅', title: '阴仪受压·子午动荡', analysis: '年支午火克制、挤压癸水，阴仪气机退却。日时需扶助生扶癸水；若见子水，子午相冲，格局气机动荡，人生得失起伏明显。' },
  { id: 5, yearGZ: '甲申', monthGZ: '丙寅', title: '金气暗藏·忌全盘木火', analysis: '年月无致命损伤，年支申金暗藏气机隐患。忌日时全盘木火制金，引发格局凶性；核心需保全丙、癸二气无伤，如甲申、丙寅、乙卯、辛巳格局，为大贵格局。' },
  { id: 6, yearGZ: '甲戌', monthGZ: '丙寅', title: '燥土藏火·忌丁孤立', analysis: '戌中丁火偏弱，易被湿气晦损；忌日时丁火孤立无援、遭干支克制。格局总纲：水火气机彰显，阴阳二气互不损伤。' },
]
